...
{{- printf "%s-%s" .Release.Name  .Values.apptype | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s-%s" .Release.Name $name .Values.apptype | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
{{- end }}
...
*/}}
{{- define "odoo.labels" -}}
cloudclusters.net/chart: {{ include "odoo.chart" . }}
{{ include "odoo.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: cloudclusters
{{- end }}
